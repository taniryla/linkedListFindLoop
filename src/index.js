...
the actual node that loops (not just its value)

2. What are the data inputs?

head of a singly linked list that contains a find a Loop


3. Can you restate the problem in your own words?

the list's tail node points to some node in the list and not null
...
if the head loops with the tail
